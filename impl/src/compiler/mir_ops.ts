...
type NormalizationContext = Map<string, number>;
...
class MIRConstantNone extends MIRConstantArgument {
  ...
  normalize(ctx : NormalizationContext) : object {
    return { ...super.normalize(ctx), const_value : "none" };
  }
}
...
class MIRConstantTrue extends MIRConstantArgument {
  ...
  normalize(ctx : NormalizationContext) : object {
    return { ...super.normalize(ctx), const_value : "true" };
  }
}
...
class MIRConstantFalse extends MIRConstantArgument {
  ...
  normalize(ctx : NormalizationContext) : object {
    return { ...super.normalize(ctx), const_value : "false" };
  }
}
...
class MIRConstantInt extends MIRConstantArgument {
  ...
  normalize(ctx : NormalizationContext) : object {
    return { ...super.normalize(ctx), const_value : this.value };
  }
}
...
abstract class MIRValueOp extends MIROp {
  ...
  normalize(ctx : NormalizationContext) : object {
    return { ...super.normalize(ctx), trgt: this.trgt.normalize(ctx) };
  }
}
...
class MIRLoadConst extends MIRValueOp {
  ...
  normalize(ctx : NormalizationContext){
    return { ...super.normalize(ctx), src : this.src.normalize(ctx) };
  }
}
...
class MIRProjectFromIndecies extends MIRValueOp {
  resultProjectType: MIRResolvedTypeKey; arg: MIRArgument;
  argInferType: MIRResolvedTypeKey;
