...
class MIRInvokeBodyDecl extends MIRInvokeDecl {
  ...
  simplify(to_remove : Map<MIRInvokeKey, MIRInvokeKey>) : MIRInvokeBodyDecl {

    this.body.body.forEach((value, key) => 
      this.body.body.set(key, value.simplify(to_remove))
    );
...
class MIRAssembly {
  ...
  simplify(to_remove : Map<MIRInvokeKey, MIRInvokeKey>){
    //this.literalRegexs;
    //this.validatorRegexs;
    //this.constantDecls; 
    //this.fieldDecls;
    //this.entryPoints;
    // TODO:

    this.invokeDecls.forEach((value, key) => 
      this.invokeDecls.set(key, value.simplify(to_remove))
    );

    

    //this.primitiveInvokeDecls;
    // TODO: ?
    //this.conceptDecls;
    // TODO: ?
    //this.entityDecls;
