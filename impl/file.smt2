...
(declare-fun @list_all$fn__file_bsq_6__97I36I (nscore__list_t_nscore__int_I10I) Bool)
...
(define-fun fn__file_bsq_6__97I36I ((xI35I Int)) Result@Bool 
(let ((__tmp_0I37I (= xI35I 0)))
...
(define-fun nscore__list__s_all_t_nscore__int__file_bsq_6_0_I39I ((lI33I nscore__list_t_nscore__int_I10I)) Result@Bool 
  (result_success@Bool (@list_all$fn__file_bsq_6__97I36I lI33I))
)
(define-fun nscore__list__allof_t_nscore__int__file_bsq_6_0___llogic_done_3I41I ((__tmp_0_2I40I Bool)) Result@Bool 
(let ((___ir_ret__I38I __tmp_0_2I40I))
    (let (($return ___ir_ret__I38I))
      (result_success@Bool $return)
    )
  ))
(define-fun nscore__list__allof_t_nscore__int__file_bsq_6_0_I43I ((thisI42I nscore__list_t_nscore__int_I10I)) Result@Bool 
        ...
        (let ((__tmp_1I45I (= __tmp_2I44I 0)))
          (ite __tmp_1I45I
            (let ((__tmp_0_1I46I true))
              (let ((@tmpvar@1 (nscore__list__allof_t_nscore__int__file_bsq_6_0___llogic_done_3I41I __tmp_0_1I46I)))
            ...
            (let ((@tmpvar@2 (nscore__list__s_all_t_nscore__int__file_bsq_6_0_I39I thisI42I)))
              (ite (is-result_error@Bool @tmpvar@2)
                @tmpvar@2
                (let ((__tmp_5I48I (result_success_value@Bool @tmpvar@2)))
                  (let ((__tmp_0I37I __tmp_5I48I))
                    (let ((@tmpvar@3 (nscore__list__allof_t_nscore__int__file_bsq_6_0___llogic_done_3I41I __tmp_0I37I)))
...
(define-fun nscore__list__get_t_nscore__int___pre__llogic_done_3I50I ((__tmp_0_2I40I Bool)) Result@Bool 
(let ((___ir_ret__I38I __tmp_0_2I40I))
    (let (($return ___ir_ret__I38I))
      (result_success@Bool $return)
    )
  ))
(define-fun nscore__list__get_t_nscore__int___preI52I ((thisI42I nscore__list_t_nscore__int_I10I) (iI51I Int)) Result@Bool 
(let ((__tmp_1I45I (or (< 0 iI51I) (= 0 iI51I))))
    (ite __tmp_1I45I
      (let ((@tmpvar@4 (nscore__list__s_size_t_nscore__int_I34I thisI42I)))
        (ite (is-result_error@Int @tmpvar@4)
          (result_error@Bool (result_error_code@Int @tmpvar@4))
          (let ((__tmp_6I53I (result_success_value@Int @tmpvar@4)))
            (let ((__tmp_4I54I (< iI51I __tmp_6I53I)))
              (let ((__tmp_0_1I46I __tmp_4I54I))
                (let ((@tmpvar@5 (nscore__list__get_t_nscore__int___pre__llogic_done_3I50I __tmp_0_1I46I)))
                  (ite (is-result_error@Bool @tmpvar@5)
                    @tmpvar@5
                    (let ((__tmp_100001I47I (result_success_value@Bool @tmpvar@5)))
                      (let (($return __tmp_100001I47I))
                        (result_success@Bool $return)
                      )
                    )
      ...
      (let ((__tmp_0I37I false))
        (let ((@tmpvar@6 (nscore__list__get_t_nscore__int___pre__llogic_done_3I50I __tmp_0I37I)))
          (ite (is-result_error@Bool @tmpvar@6)
            @tmpvar@6
            (let ((__tmp_100000I49I (result_success_value@Bool @tmpvar@6)))
              (let (($return __tmp_100000I49I))
                (result_success@Bool $return)
              )
            )
...
(define-fun nscore__list__s_unsafe_get_t_nscore__int_I55I ((lI33I nscore__list_t_nscore__int_I10I) (iI51I Int)) Result@Int 
  (result_success@Int (select (nscore__list_t_nscore__int_I10I@@entries lI33I) iI51I))
)
(define-fun nscore__list__get_t_nscore__int_I56I ((thisI42I nscore__list_t_nscore__int_I10I) (iI51I Int)) Result@Int 
(let ((@tmpvar@7 (nscore__list__get_t_nscore__int___preI52I thisI42I iI51I)))
    (ite (is-result_error@Bool @tmpvar@7)
      (result_error@Int (result_error_code@Bool @tmpvar@7))
      (let ((__tmp_0I37I (result_success_value@Bool @tmpvar@7)))
        (ite __tmp_0I37I
          (let ((@tmpvar@8 (nscore__list__s_unsafe_get_t_nscore__int_I55I thisI42I iI51I)))
            (ite (is-result_error@Int @tmpvar@8)
              @tmpvar@8
              (let ((__tmp_1I45I (result_success_value@Int @tmpvar@8)))
                (let ((___ir_ret__I38I __tmp_1I45I))
                  (let (($return ___ir_ret__I38I))
...
(define-fun nsmain__main__lifstmt_done_3I57I () Result@Int 
(let ((___ir_ret__I38I 0))
    (let (($return ___ir_ret__I38I))
      (result_success@Int $return)
    )
  ))
(define-fun nsmain__mainI58I () Result@Int 
(let ((__tmp_0I37I (nscore__list_t_nscore__int_I10I@cons 2 (store (store nscore__list_t_nscore__int__collection_data_array_emptyI11I 0 1) 1 2))))
    (let ((lI33I __tmp_0I37I))
      (let ((@tmpvar@9 (nscore__list__allof_t_nscore__int__file_bsq_6_0_I43I lI33I)))
        (ite (is-result_error@Bool @tmpvar@9)
          (result_error@Int (result_error_code@Bool @tmpvar@9))
          (let ((__tmp_3I59I (result_success_value@Bool @tmpvar@9)))
            (ite __tmp_3I59I
              (let ((@tmpvar@10 (nscore__list__get_t_nscore__int_I56I lI33I 0)))
                (ite (is-result_error@Int @tmpvar@10)
                  @tmpvar@10
                  (let ((__tmp_7I60I (result_success_value@Int @tmpvar@10)))
                    (let ((__tmp_6I53I (= __tmp_7I60I 0)))
                      (ite __tmp_6I53I
                        (let ((@tmpvar@11 nsmain__main__lifstmt_done_3I57I))
                          (ite (is-result_error@Int @tmpvar@11)
                            @tmpvar@11
                            (let ((__tmp_100001I47I (result_success_value@Int @tmpvar@11)))
                              (let (($return __tmp_100001I47I))
                                (result_success@Int $return)
                              )
                            )
              ...
              (let ((@tmpvar@12 nsmain__main__lifstmt_done_3I57I))
                (ite (is-result_error@Int @tmpvar@12)
                  @tmpvar@12
                  (let ((__tmp_100000I49I (result_success_value@Int @tmpvar@12)))
                    (let (($return __tmp_100000I49I))
                      (result_success@Int $return)
                    )
                  )
...
(assert (forall ((l nscore__list_t_nscore__int_I10I) (i Int)) (=> (@list_all$fn__file_bsq_6__97I36I l) (result_success_value@Bool (fn__file_bsq_6__97I36I (select (nscore__list_t_nscore__int_I10I@@entries l) i))))))
(assert (forall ((l nscore__list_t_nscore__int_I10I)) (=> (= (nscore__list_t_nscore__int_I10I@@size l) 0) (@list_all$fn__file_bsq_6__97I36I l))))
