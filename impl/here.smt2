...
(declare-fun @list_any$fn__list_short_example2_bsq_6__127I46I (nscore__list_t_nscore__int_I10I) Bool)
(declare-fun @list_fill (Int Int) nscore__list_t_nscore__int_I10I)
(declare-fun extra_@list_any$fn__list_short_example2_bsq_6__127I46I (nscore__list_t_nscore__int_I10I Int Int) Bool)
(define-fun nscore__list__fill_t_nscore__int___preI35I ((kI33I Int) (valI34I Int)) Result@Bool 
(let ((__tmp_0I36I (or (< 0 kI33I) (= 0 kI33I))))
    (let ((___ir_ret__I37I __tmp_0I36I))
      (let (($return ___ir_ret__I37I))
        (result_success@Bool $return)
      )
    )
  ))
(define-fun nscore__list__s_fill_t_nscore__int_I38I ((kI33I Int) (valI34I Int)) Result@nscore__list_t_nscore__int_I10I 
  (result_success@nscore__list_t_nscore__int_I10I (@list_fill kI33I valI34I))
)
(define-fun nscore__list__fill_t_nscore__int_I39I ((kI33I Int) (valI34I Int)) Result@nscore__list_t_nscore__int_I10I 
(let ((@tmpvar@0 (nscore__list__fill_t_nscore__int___preI35I kI33I valI34I)))
    (ite (is-result_error@Bool @tmpvar@0)
      (result_error@nscore__list_t_nscore__int_I10I (result_error_code@Bool @tmpvar@0))
      (let ((__tmp_0I36I (result_success_value@Bool @tmpvar@0)))
        (ite __tmp_0I36I
          (let ((@tmpvar@1 (nscore__list__s_fill_t_nscore__int_I38I kI33I valI34I)))
            (ite (is-result_error@nscore__list_t_nscore__int_I10I @tmpvar@1)
              @tmpvar@1
              (let ((__tmp_1I40I (result_success_value@nscore__list_t_nscore__int_I10I @tmpvar@1)))
                (let ((___ir_ret__I37I __tmp_1I40I))
                  (let (($return ___ir_ret__I37I))
          ...
          (result_error@nscore__list_t_nscore__int_I10I (result_error 0))
        )
      )
    )
  ))
(define-fun nscore__list__s_size_t_nscore__int_I42I ((lI41I nscore__list_t_nscore__int_I10I)) Result@Int 
  (result_success@Int (nscore__list_t_nscore__int_I10I@@size lI41I))
)
(define-fun nscore__list__anyof_t_nscore__int__list_short_example2_bsq_6_0___llogic_done_3I44I ((__tmp_0_2I43I Bool)) Result@Bool 
(let ((___ir_ret__I37I __tmp_0_2I43I))
    (let (($return ___ir_ret__I37I))
      (result_success@Bool $return)
    )
  ))
(define-fun fn__list_short_example2_bsq_6__127I46I ((xI45I Int)) Result@Bool 
(let ((__tmp_0I36I (= xI45I 1)))
    (let ((___ir_ret__I37I __tmp_0I36I))
      (let (($return ___ir_ret__I37I))
        (result_success@Bool $return)
      )
...
(define-fun nscore__list__s_any_t_nscore__int__list_short_example2_bsq_6_0_I47I ((lI41I nscore__list_t_nscore__int_I10I)) Result@Bool 
  (result_success@Bool (@list_any$fn__list_short_example2_bsq_6__127I46I lI41I))
)
(define-fun nscore__list__anyof_t_nscore__int__list_short_example2_bsq_6_0_I49I ((thisI48I nscore__list_t_nscore__int_I10I)) Result@Bool 
(let ((@tmpvar@2 (nscore__list__s_size_t_nscore__int_I42I thisI48I)))
    (ite (is-result_error@Int @tmpvar@2)
      (result_error@Bool (result_error_code@Int @tmpvar@2))
      (let ((__tmp_2I50I (result_success_value@Int @tmpvar@2)))
        (let ((__tmp_1I40I (not (= __tmp_2I50I 0))))
          (ite __tmp_1I40I
            (let ((@tmpvar@3 (nscore__list__s_any_t_nscore__int__list_short_example2_bsq_6_0_I47I thisI48I)))
              (ite (is-result_error@Bool @tmpvar@3)
                @tmpvar@3
                (let ((__tmp_5I51I (result_success_value@Bool @tmpvar@3)))
                  (let ((__tmp_0_1I52I __tmp_5I51I))
                    (let ((@tmpvar@4 (nscore__list__anyof_t_nscore__int__list_short_example2_bsq_6_0___llogic_done_3I44I __tmp_0_1I52I)))
                      (ite (is-result_error@Bool @tmpvar@4)
                        @tmpvar@4
                        (let ((__tmp_100001I53I (result_success_value@Bool @tmpvar@4)))
            ...
            (let ((__tmp_0I36I false))
              (let ((@tmpvar@5 (nscore__list__anyof_t_nscore__int__list_short_example2_bsq_6_0___llogic_done_3I44I __tmp_0I36I)))
                (ite (is-result_error@Bool @tmpvar@5)
                  @tmpvar@5
                  (let ((__tmp_100000I54I (result_success_value@Bool @tmpvar@5)))
                    (let (($return __tmp_100000I54I))
                      (result_success@Bool $return)
                    )
                  )
                )
...
(define-fun nsmain__mainI55I () Result@Int 
(let ((@tmpvar@6 (nscore__list__fill_t_nscore__int_I39I 10 1)))
    (ite (is-result_error@nscore__list_t_nscore__int_I10I @tmpvar@6)
      (result_error@Int (result_error_code@nscore__list_t_nscore__int_I10I @tmpvar@6))
      (let ((__tmp_0I36I (result_success_value@nscore__list_t_nscore__int_I10I @tmpvar@6)))
        (let ((filled_listI56I __tmp_0I36I))
          (let ((@tmpvar@7 (nscore__list__anyof_t_nscore__int__list_short_example2_bsq_6_0_I49I filled_listI56I)))
            (ite (is-result_error@Bool @tmpvar@7)
              (result_error@Int (result_error_code@Bool @tmpvar@7))
              (let ((__tmp_3I57I (result_success_value@Bool @tmpvar@7)))
                (ite __tmp_3I57I
                  (let ((___ir_ret__I37I 0))
                    (let (($return ___ir_ret__I37I))
...
(assert (forall ((k Int) (val Int) (i Int))
              (implies (and (<= 0 i) (< i k)) (= (select (nscore__list_t_nscore__int_I10I@@entries (@list_fill k val)) i) val))
            ))
(assert (forall ((l nscore__list_t_nscore__int_I10I) (k Int) (val Int)) 
               (= (nscore__list_t_nscore__int_I10I@@size (@list_fill k val)) k)
             ))
(assert (forall ((l nscore__list_t_nscore__int_I10I)) 
              (iff 
               (@list_any$fn__list_short_example2_bsq_6__127I46I l) 
               (exists ((i Int)) (result_success_value@Bool (fn__list_short_example2_bsq_6__127I46I (select (nscore__list_t_nscore__int_I10I@@entries l) i))))
             )))
(assert (forall ((l nscore__list_t_nscore__int_I10I)) (=> (= (nscore__list_t_nscore__int_I10I@@size l) 0) (not (@list_any$fn__list_short_example2_bsq_6__127I46I l)))))



(declare-const @smtres@ Result@Int)
(assert (= @smtres@ nsmain__mainI55I))
