...
class TypeEnvironment {
    constructor(scope, terms, refparams, pcodes, args, locals, expressionResult, rflow, yflow, yieldTrgtInfo, frozenVars) {
        this.scope = scope;
        this.terms = terms;
    ...
    static createInitialEnvForCall(scope, terms, refparams, pcodes, args) {
        return new TypeEnvironment(scope, terms, refparams, pcodes, args, [new Map()], undefined, undefined, undefined, [], new Set());
    }
    hasNormalFlow() {
    ...
    setExpressionResult(assembly, etype, value) {
