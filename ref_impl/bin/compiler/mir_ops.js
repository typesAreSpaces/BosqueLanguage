...
function extractMirBodyKeyPrefix(bkey) {
    return bkey.substring(0, bkey.indexOf("::"));
}
exports.extractMirBodyKeyPrefix = extractMirBodyKeyPrefix;
function extractMirBodyKeyData(bkey) {
    return bkey.substring(bkey.indexOf("::") + 2);
}
exports.extractMirBodyKeyData = extractMirBodyKeyData;
//
...
(function (MIROpTag) {
    ...
    MIROpTag["MIRProjectFromTypeConcept"] = "MIRProjectFromTypeConcept";
    ...
    MIROpTag["MIRLogicStore"] = "MIRLogicStore";
...
class MIRAccessFromIndex extends MIRValueOp {
    constructor(sinfo, resultAccessType, arg, idx, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultAccessType: this.resultAccessType, arg: this.arg.jemit(), idx: this.idx });
    }
    static jparse(jobj) {
...
class MIRProjectFromIndecies extends MIRValueOp {
    constructor(sinfo, resultProjectType, arg, indecies, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultProjectType: this.resultProjectType, arg: this.arg.jemit(), indecies: this.indecies });
    }
    static jparse(jobj) {
...
class MIRAccessFromProperty extends MIRValueOp {
    constructor(sinfo, resultAccessType, arg, property, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultAccessType: this.resultAccessType, arg: this.arg.jemit(), property: this.property });
    }
    static jparse(jobj) {
...
class MIRProjectFromProperties extends MIRValueOp {
    constructor(sinfo, resultProjectType, arg, properties, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultProjectType: this.resultProjectType, arg: this.arg.jemit(), properties: this.properties });
    }
    static jparse(jobj) {
...
class MIRAccessFromField extends MIRValueOp {
    constructor(sinfo, resultAccessType, arg, field, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultAccessType: this.resultAccessType, arg: this.arg.jemit(), field: this.field });
    }
    static jparse(jobj) {
...
class MIRProjectFromFields extends MIRValueOp {
    constructor(sinfo, resultProjectType, arg, fields, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultProjectType: this.resultProjectType, arg: this.arg.jemit(), fields: this.fields });
    }
    static jparse(jobj) {
...
class MIRProjectFromTypeTuple extends MIRValueOp {
    constructor(sinfo, resultProjectType, arg, ptype, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultProjectType: this.resultProjectType, arg: this.arg.jemit(), ptype: this.ptype });
    }
    static jparse(jobj) {
...
class MIRProjectFromTypeConcept extends MIRValueOp {
    constructor(sinfo, resultProjectType, arg, ctypes, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultProjectType: this.resultProjectType, arg: this.arg.jemit(), ctypes: this.ctypes });
    }
    static jparse(jobj) {
...
exports.MIRProjectFromTypeConcept = MIRProjectFromTypeConcept;
class MIRModifyWithIndecies extends MIRValueOp {
    constructor(sinfo, resultTupleType, arg, updates, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultTupleType: this.resultTupleType, arg: this.arg.jemit(), udpates: this.updates.map((update) => [update[0], update[1].jemit()]) });
    }
    static jparse(jobj) {
        return new MIRModifyWithIndecies(jparsesinfo(jobj.sinfo), jobj.resultTupleType, MIRArgument.jparse(jobj.arg), jobj.updates.map((update) => [update[0], MIRArgument.jparse(update[1])]), MIRTempRegister.jparse(jobj.trgt));
    }
}
exports.MIRModifyWithIndecies = MIRModifyWithIndecies;
class MIRModifyWithProperties extends MIRValueOp {
    constructor(sinfo, resultRecordType, arg, updates, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultRecordType: this.resultRecordType, arg: this.arg.jemit(), udpates: this.updates.map((update) => [update[0], update[1].jemit()]) });
    }
    static jparse(jobj) {
        return new MIRModifyWithProperties(jparsesinfo(jobj.sinfo), jobj.resultRecordType, MIRArgument.jparse(jobj.arg), jobj.updates.map((update) => [update[0], MIRArgument.jparse(update[1])]), MIRTempRegister.jparse(jobj.trgt));
    }
}
exports.MIRModifyWithProperties = MIRModifyWithProperties;
class MIRModifyWithFields extends MIRValueOp {
    constructor(sinfo, resultNominalType, arg, updates, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultNominalType: this.resultNominalType, arg: this.arg.jemit(), updates: this.updates.map((update) => [update[0], update[1].jemit()]) });
    }
    static jparse(jobj) {
        return new MIRModifyWithFields(jparsesinfo(jobj.sinfo), jobj.resultNominalType, MIRArgument.jparse(jobj.arg), jobj.updates.map((update) => [update[0], MIRArgument.jparse(update[1])]), MIRTempRegister.jparse(jobj.trgt));
    }
}
exports.MIRModifyWithFields = MIRModifyWithFields;
class MIRStructuredExtendTuple extends MIRValueOp {
    constructor(sinfo, resultTupleType, arg, update, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultTupleType: this.resultTupleType, arg: this.arg.jemit(), udpate: this.update.jemit() });
    }
    static jparse(jobj) {
...
class MIRStructuredExtendRecord extends MIRValueOp {
    constructor(sinfo, resultRecordType, arg, update, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultRecordType: this.resultRecordType, arg: this.arg.jemit(), udpate: this.update.jemit() });
    }
    static jparse(jobj) {
...
class MIRStructuredExtendObject extends MIRValueOp {
    constructor(sinfo, resultNominalType, arg, update, fieldResolves, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultNominalType: this.resultNominalType, arg: this.arg.jemit(), udpate: this.update.jemit(), fieldResolves: this.fieldResolves });
    }
    static jparse(jobj) {
...
class MIRInvokeVirtualFunction extends MIRValueOp {
    constructor(sinfo, resultType, vresolve, args, trgt) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { resultType: this.resultType, vresolve: this.vresolve, args: this.args.map((arg) => arg.jemit()) });
    }
    static jparse(jobj) {
        return new MIRInvokeVirtualFunction(jparsesinfo(jobj.sinfo), jobj.resultType, jobj.vresolve, jobj.args.map((arg) => MIRArgument.jparse(arg)), MIRTempRegister.jparse(jobj.trgt));
    }
}
...
class MIRLogicStore extends MIRFlowOp {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { lhs: this.lhs.jemit(), op: this.op, rhs: this.rhs.jemit(), trgt: this.trgt.jemit() });
    }
    static jparse(jobj) {
...
exports.MIRLogicStore = MIRLogicStore;
...
class MIRAbort extends MIRFlowOp {
    constructor(sinfo, releaseEnable, info) {
    ...
    jemit() {
        return Object.assign(Object.assign({}, this.jbemit()), { releaseEnable: this.releaseEnable, info: this.info });
    }
    static jparse(jobj) {
...
class MIRBody {
    constructor(file, sinfo, bkey, body, vtypes) {
        this.file = file;
        this.sinfo = sinfo;
        this.bkey = bkey;
        this.body = body;
