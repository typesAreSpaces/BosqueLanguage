...
let nSMain__main  = 
  ...
  let x = __tmp_9 in
  let __tmp_10_arg_3 = (BBool false) in
  let __tmp_10_arg_2 = (BBool true) in
  let __tmp_10_arg_1 = (BInt 2) in
  let __tmp_10_arg_0 = (BInt 1) in
  let _ = assert_norm(subtypeOf BBoolType (getType __tmp_10_arg_3)) in
  ...
  let __tmp_10 = (BnSMain__Baz3 __tmp_10_arg_0 __tmp_10_arg_1 __tmp_10_arg_2 __tmp_10_arg_3) in
  let e = __tmp_10 in
  let _ = assert_norm(subtypeOf BnSMain__Baz3Type (getType e)) in
  let __tmp_17 = (projectBnSMain__Baz3_f e) in
  let e2 = __tmp_17 in
  let __fresh_name1NSMain__main = (projectBnSMain__Baz3_k e) in
